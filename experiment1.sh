...
JOBID1=$(sbatch --parsable --array=1-20 sbatch_run_all_iters.sh 601 npos indep)
...
sbatch --dependency=afterok:$JOBID1 --wrap "Rscript format_mse_results.R 20 601 npos indep"

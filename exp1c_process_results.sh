...
#SBATCH --output=/home/<NAME>/debiased_regression/output/log/log_exp1c_process_results.stdout
#SBATCH --error=/home/<NAME>/debiased_regression/output/log/error_exp1c_process_results.stderr

...
#SBATCH --output=/home/<NAME>/debiased_regression/output/log/log_exp1e_compare_pos_indep.stdout
#SBATCH --error=/home/<NAME>/debiased_regression/output/log/error_exp1e_compare_pos_indep.stderr
